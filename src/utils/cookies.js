...
let CookieHelp = {
  ...
  saveUserInfo(name,userinfo,save) {
      let time =""
      if(typeof save.valueOf()==="boolean" && save){
          time = 365*24*60*60*1000
      }else{
          time =  typeof save*1==="number"? save*1 : 65*24*60*60*1000
      }
      this.saveCookieInfo(name?name:this.getUserKey(),userinfo,time)
