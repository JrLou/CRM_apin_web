...
export default {
  ...
  effects: {
    ...
    *fetchPlanClose({ payload, succCB }, { call, put }) {
      // 关闭拼团
      yield put({
        type: "extendAll",
    ...
    *fetchGroupOrders({ payload }, { call, put }) {
      // 获取订单信息
      yield put({
        type: "extendAll",
    ...
    *fetchPaidMember({ payload }, { call, put }) {
      // 获取拼团下成功支付的乘机人信息
      yield put({
        type: "extendAll",
    ...
    *fetchExportPassenger({ payload, cb }, { call }) {
      // 导出乘机人信息（已付款的）
    ...
    *fetchPublishLogs({ payload }, { call, put }) {
      // 获取订单推送日志
      yield put({
        type: "extendAll",
        payload: { modalTableLoading: true },
    ...
    *fetchDetailGroupVoyage({ payload }, { call, put }) {
      // 获取方案明细
      yield put({
        type: "extendAll",
    ...
    *fetchGroupLogs({ payload }, { call, put }) {
      // 获取日志信息
      yield put({
        type: "extendAll",
